...
def get_continuation_prompt(story):
    continuation_prompt = f'''I want you to continue telling a story. It should have a rich narrative filled with \
    vivid characters, intriguing quests, and unexpected twists. The story so far is {story}\n {FORMATTING_DEFINITION} \
    I will choose one of the choices you provide and you will continue with the story based on the choice I will \
    write. Your response cannot be longer than 1000 words, but should be rather short. The options to choose from \
    should also be rather short. Do not use any formatting in your response. \
